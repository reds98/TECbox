...
/** @docs-private */
export declare class matRangeDatepickerContentBase {
    _elementRef: ElementRef;
    constructor(_elementRef: ElementRef);
}
export declare const _matRangeDatepickerContentMixinBase: (new (...args: any[]) => CanColor) & typeof matRangeDatepickerContentBase;
/**
 ...
 * @docs-private
 */
export declare class matRangeDatepickerContent<D> extends _matRangeDatepickerContentMixinBase implements AfterViewInit, CanColor, OnInit, OnDestroy {
    private _changeDetectorRef;
    private _ngZone;
    /** Subscription to changes in the overlay's position. */
    private _positionChange;
    /** Reference to the internal calendar component. */
    _calendar: RangeCalendar<D>;
...
export declare class matRangeDatepicker<D> implements OnDestroy, CanColor {
    private _dialog;
    private _overlay;
    private _ngZone;
    ...
    readonly _selectedChanged: Subject<D | matRangeDatepickerRangeValue<D>>;
