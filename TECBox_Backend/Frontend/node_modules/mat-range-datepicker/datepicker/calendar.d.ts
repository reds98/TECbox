...
export declare class SatCalendar<D> implements AfterContentInit, AfterViewChecked, OnDestroy, OnChanges {
    ...
    dateSelected: EventEmitter<matRangeDatepickerRangeValue<D>>;
    ...
    constructor(_intl: matRangeDatepickerIntl, _dateAdapter: DateAdapter<D>, _dateFormats: MatDateFormats, changeDetectorRef: ChangeDetectorRef);
...
export declare class SatCalendarHeader<D> {
    ...
    private _dateAdapter;
    private _dateFormats;
    constructor(_intl: matRangeDatepickerIntl, calendar: SatCalendar<D>, _dateAdapter: DateAdapter<D>, _dateFormats: MatDateFormats, changeDetectorRef: ChangeDetectorRef);
