...
var NativeDateAdapter = /** @class */ (function (_super) {
    ...
    NativeDateAdapter.prototype.getFirstDayOfWeek = function () {
        ...
        var /** @type {?} */ locale = this.locale.toLowerCase();
...
var MatRangeNativeDateModule = /** @class */ (function () {
    function MatRangeNativeDateModule() {
    }
    return MatRangeNativeDateModule;
}());
MatRangeNativeDateModule.decorators = [
    { type: NgModule, args: [{
 ...
 */
var matRangeDatepickerIntl = /** @class */ (function () {
    function matRangeDatepickerIntl() {
        /**
    ...
    return matRangeDatepickerIntl;
}());
matRangeDatepickerIntl.decorators = [
 ...
 * @template D
 */
var RangeCalendar = /** @class */ (function () {
    /**
     * @param {?} _intl
     * @param {?} _dateAdapter
     * @param {?} _dateFormats
     */
    function RangeCalendar(_intl, _dateAdapter, _dateFormats) {
        this._dateAdapter = _dateAdapter;
        this._dateFormats = _dateFormats;
        this.selectedChange = new EventEmitter();
     ...
     * @return {?}
     */
    RangeCalendar.prototype._dateSelected = function (date) {
        if (this.rangeMode) {
            if (!this._beginDateSelected) {
                this._beginDateSelected = true;
                this.beginDate = date;
     ...
     * @return {?}
     */
    RangeCalendar.prototype._getQuarterDates = function (quarter) {
        var /** @type {?} */ _year = this._dateAdapter.getYear(this._dateAdapter.today());
        var /** @type {?} */ begin = this._dateAdapter.createDate(_year, (quarter - 1) * 3, 1);
        var /** @type {?} */ end = (quarter === 4
            ?
     ...
     * @return {?}
     */
    RangeCalendar.prototype.selectQuater = function (quarter) {
     ...
     * @return {?}
     */
    RangeCalendar.prototype.checkQuarterSelected = function (quarter) {
        var _a = this._getQuarterDates(quarter), begin = _a.begin, end = _a.end;
     ...
     * @return {?}
     */
    RangeCalendar.prototype.onCancel = function () {
        this._userSelection.emit();
    };
    /**
     * @return {?}
     */
    RangeCalendar.prototype.onApply = function () {
...
/** @nocollapse */
RangeCalendar.ctorParameters = function () { return [
    { type: matRangeDatepickerIntl, },
    { type: DateAdapter, decorators: [{ type: Optional },] },
    { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [MAT_DATE_FORMATS,] },] },
]; };
 ...
 */
var /** @type {?} */ MAT_DATEPICKER_SCROLL_STRATEGY = new InjectionToken('mat-range-datepicker-scroll-strategy', {
    providedIn: 'root',
...
var /** @type {?} */ _matRangeDatepickerContentMixinBase = mixinColor(matRangeDatepickerContentBase);
/**
...
var matRangeDatepickerContent = /** @class */ (function (_super) {
    __extends(matRangeDatepickerContent, _super);
    /**
     * @param {?} elementRef
     * @param {?} _changeDetectorRef
     * @param {?} _ngZone
 ...
 * @suppress {checkTypes} checked by tsc
 */
var MatRangeDatepickerModule = /** @class */ (function () {
    function MatRangeDatepickerModule() {
    }
    return MatRangeDatepickerModule;
}());
MatRangeDatepickerModule.decorators = [
    { type: NgModule, args: [{
                imports: [
                    CommonModule,
                    MatButtonModule,
